...
class MockSearchRemoteDataSource extends _i1.Mock
  ...
  _i3.Future<List<_i4.ApodModel>> fetchApodByDateRange(
    ...
    String? endDate,
      ...
      (super.noSuchMethod(
            Invocation.method(#fetchApodByDateRange, [startDate, endDate]),
            returnValue: _i3.Future<List<_i4.ApodModel>>.value(
              <_i4.ApodModel>[],
            ),
            returnValueForMissingStub: _i3.Future<List<_i4.ApodModel>>.value(
              <_i4.ApodModel>[],
            ),
          )
...
class MockSearchLocalDataSource extends _i1.Mock
  ...
  @override
  _i3.Future<List<String>> fetchSearchHistory() =>
      (super.noSuchMethod(
            Invocation.method(#fetchSearchHistory, []),
  ...
  @override
  _i3.Future<List<String>> updateSearchHistory(List<String>? historyList) =>
      (super.noSuchMethod(
            Invocation.method(#updateSearchHistory, [historyList]),
            returnValue: _i3.Future<List<String>>.value(<String>[]),
            returnValueForMissingStub: _i3.Future<List<String>>.value(
              <String>[],
            ),
